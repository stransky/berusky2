...
int adas_AC3_Init(void)
{
  ...
  ALEAXAC3GetFunctionTable =
    (LPALEAXAC3GETFUNCTIONTABLE) alGetProcAddress(szFnName);
...
void adas_AC3_Get_Device_Caps(int Device, EAXAC3DEVICEINFO * p_Device_Info)
{
  ...
  if (FAILED(hr =
      g_lpEAXAC3FnTable->EAXAC3QueryDeviceCaps(Device, p_Device_Info,
  ...
  AC3STREAM * p_AC3_Stream, LPAC3CALLBACK AC3_Call_Back)
{
  ...
  if (FAILED(hr =
      g_lpEAXAC3FnTable->EAXAC3OpenStream(Device, p_AC3_Stream, AC3_Call_Back,
        p_File_Name, AC3FILE))) {
    char text[256];
  ...
  int iValue)
{
  ...
  if (FAILED(hr =
      g_lpEAXAC3FnTable->EAXAC3SetFilePosition(AC3_Stream,
        (enum POSFORMAT) Pos_Format, iValue))) {
    char text[256];
  ...
  int *iValue)
{
  ...
  if (FAILED(hr =
      g_lpEAXAC3FnTable->EAXAC3GetPosition(AC3_Stream,
        (enum POSFORMAT) Pos_Format, iValue))) {
    char text[256];
