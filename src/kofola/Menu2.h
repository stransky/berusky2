...
#include "animationk.h"
	...
	void RunMenuSettings2(char *p_File_Name, void *p_ad, LEVELINFO *p_Level, ANIMATION_MODULE *p_am);
	int RunMenuLoadGameLoad2(char *p_File_Name, void *p_ad, LEVELINFO *p_Level, ANIMATION_MODULE *p_am, char bLoad, WCHAR *cText);
