...
}  inline void transformuj_objekt_matici(EDIT_OBJEKT * p_obj,
  GLMATRIX * p_mat) 
{
...
 inline void transformuj_mesh_matici(GAME_MESH_OLD * p_mesh,
  GLMATRIX * p_m) 
{
...
void kontejner_obalka_aabb(EDIT_KONTEJNER * p_kont, BOD * p_min,
  BOD * p_max);
