...
EDIT_KONTEJNER * lo_nahraj_kontejner_chunk(EDIT_MATERIAL **p_mat, int max_mat, EDIT_TEXT *p_text, int max_text, byte *p_jmeno, int mat, int normal);

int  lo_uloz_material_chunk(FFILE f, EDIT_MATERIAL *p_mat);
int  lo_nahraj_materialy_chunk(EDIT_MATERIAL **p_mat, int max_mat, EDIT_TEXT *p_text, int max_text, byte *p_file, int save);
