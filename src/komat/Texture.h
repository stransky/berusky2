...
int  txt_nahraj_texturu_z_func(APAK_HANDLE *pHandle, const char *p_file, EDIT_TEXT_OLD *p_text, int save, int load, EDIT_TEXT_KONFIG *p_konf, bitmapa * (*p_load)(APAK_HANDLE *pAHandle, char *p_file));
