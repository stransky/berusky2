...
/* Bodove funkce
*/
__inline void bod2mujbod(OBJ_VERTEX *p_obj, BOD *p_bod)
{
 p_obj->x = p_bod->x;
 p_obj->y = p_bod->y;
 p_obj->z = p_bod->z;
...
__inline void norm2mujbod(OBJ_VERTEX *p_obj, BOD *p_bod)
{
 p_obj->nx = p_bod->x;
 p_obj->ny = p_bod->y;
 p_obj->nz = p_bod->z;
...
__inline BOD * mujbod2bod(BOD *p_bod, OBJ_VERTEX *p_obj)
{
 p_bod->x = p_obj->x;
 p_bod->y = p_obj->y;
 p_bod->z = p_obj->z;
...
__inline ROVINA * calc_rovinu(OBJ_VERTEX *a, OBJ_VERTEX *b, OBJ_VERTEX *c, ROVINA *r)
{
...
__inline ROVINA * calc_rovinu_bod(BOD *a, BOD *b, BOD *c, ROVINA *r)
{
 r->x = (b->y - a->y)*(c->z - a->z)-(c->y - a->y)*(b->z - a->z);
 r->y = (b->z - a->z)*(c->x - a->x)-(c->z - a->z)*(b->x - a->x);
 r->z = (b->x - a->x)*(c->y - a->y)-(c->x - a->x)*(b->y - a->y);
...
__inline ROVINAD * calc_drovinu_bod(BOD *a, BOD *b, BOD *c, ROVINAD *r)
{
 r->x = (b->y - a->y)*(c->z - a->z)-(c->y - a->y)*(b->z - a->z);
 r->y = (b->z - a->z)*(c->x - a->x)-(c->z - a->z)*(b->x - a->x);
 r->z = (b->x - a->x)*(c->y - a->y)-(c->x - a->x)*(b->y - a->y);
...
#define fcopysign(val,sign)  ((float)_copysign((float)val,(float)sign))
#define fchgsign(s)          ((float)_chgsign((float)(s)))
