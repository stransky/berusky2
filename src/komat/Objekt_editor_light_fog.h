...
void oe_zarad_pruhledne_objekty(K_EDITOR * p_cnf, EDIT_KONTEJNER * p_kont,
  int k);
void setup_vertex_fog(DWORD dwColor, DWORD dwMode);
void oe_prepocitej_svetlo_obj(K_EDITOR * p_cnf, EDIT_KONTEJNER * p_kont_light,
  EDIT_OBJEKT * p_obj_light, byte cop);
void oe_prepocitej_svetlo(K_EDITOR * p_cnf, EDIT_KONTEJNER * p_kont,
  EDIT_OBJEKT ** p_obj, byte cop);
void oe_prepocitej_svetla(K_EDITOR * p_cnf, byte cop);
void oe_odecti_svetlo(K_EDITOR * p_cnf, EDIT_KONTEJNER * p_kont,
  EDIT_OBJEKT ** p_obj);
...
void kont_gourand_maping(K_EDITOR * p_cnf, EDIT_KONTEJNER * p_kont_top,
  byte cop, int multi_mesh);
...
void oe_prikaz_set_barva_scena_guids(K_EDITOR * p_cnf, int lo, int hi,
  int stat);
...
void oe_reset_barva_scena(K_EDITOR * p_cnf, EDIT_MATERIAL * p_mat, int matnum,
  int barva);
void oe_reset_barva_scena_alfa(K_EDITOR * p_cnf, EDIT_MATERIAL * p_mat,
  int matnum);
